import { processAudioComplete, SUPPORTED_LANGUAGES } from '../src/lib/audio-processor.js';
import fs from 'fs';
import path from 'path';

/**
 * Test script for audio processing pipeline
 * Tests M4A conversion, noise reduction, and Google Cloud transcription
 */
...
async function testAudioProcessing() {
    ...
    try {
        ...
        const { cleanupTempFiles } = await import('../src/lib/audio-processor.js');
